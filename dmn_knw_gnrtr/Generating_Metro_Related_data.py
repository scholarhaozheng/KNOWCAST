...
# Used to generate information about all paths corresponding to all OD pairs.
...
Generating_logit_probabilities(train_dict_file_path, OD_path_visit_prob_dic_file_path,
                                           excel_path, graph_sz_conn_root, station_index_root, result_API_root)
...
Get_Time_DepartFreDic(suzhou_sub_data_file_path, Time_DepartFreDic_filename, time_interval,
                      excel_path, graph_sz_conn_root, station_index_root, start_date_str, end_date_str, result_API_root)
